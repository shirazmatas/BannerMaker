...
public class AlphabetBanner {
    ...
    /**
     * Character list and order used for GUI display: A–Z, 0–9, ?, !, ..
     * Matches the key sets of {@link #UNBORDERED}/{@link #BORDERED}. Since HashMap is unordered,
     * this List is the source of truth for the public display order.
     */
